...
class Diagnostics_HTML():
    ...
    def get(self, *args):
        ...
        return render_template('diagnostics.html', request=request, session=session, fhdhr=self.fhdhr, button_dict=button_dict, route_group=route_group, route_groups=route_groups, list=list)
